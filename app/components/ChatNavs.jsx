...
const Web3MessengerDropdown = ({ children }) => {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <div onClick={toggleDropdown} className="size-fit">
        {children}
      </div>

      {isOpen && (
        <div className="absolute right-0 mt-2 w-[180px] shrink-0 rounded-md shadow-lg bg-purple-950 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 z-10">
          <div
            className="py-1 "
            role="menu"
          ...
          >
            <Link
              ...
              className="flex shrink-0 items-center px-4 py-2 text-sm text-slate-200 hover:bg-purple-400 hover:text-purple-100 w-full text-left transition-colors duration-200"
              role="menuitem"
            >
            ...
            <button
              ...
              className="flex items-center px-4 py-2 text-sm text-slate-200 hover:bg-purple-400 hover:text-purple-100 w-full text-left transition-colors duration-200"
              role="menuitem"
            >
              <Settings
          ...
          <div className="py-1">
            <button
              ...
              className="flex items-center px-4 py-3 text-sm text-red-700 hover:bg-red-50 hover:text-red-900 w-full text-left transition-colors duration-200"
              role="menuitem"
            >
              <LogOut
