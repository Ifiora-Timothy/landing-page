...
import { SolLogo } from "@/(auth)/_components/MobileAuth";
...
sm:flex
    ...
    >
      ...
      <div className="absolute shrink-0  inset-0 bg-gradient-to-r from-blue-500 to-teal-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
